          ...
          features.contains('wifi') || features.contains('وايفاي')
              ...
              features.contains('Desk') || features.contains('مكتب')
                  ...
                  features.contains('TV') || features.contains('تلفاز')
                      ...
                      :
                      //----------------------------------------------------------------
                      features.contains('Wake') ||
                              features.contains('خدمة الإيقاظ')
                          ...
                          features.contains('Iron') || features.contains('الكي')
                              ...
                              :
                              //----------------------------------------------------------------
                              features.contains('Socket') ||
                                      features.contains('مقبس')
                                  ? featureContainer(icon: Icons.power)
                                  :
                                  //----------------------------------------------------------------
                                  features.contains('Tea') ||
                                          features.contains('شاي')
                                      ? featureContainer(
                                          icon: Icons.coffee_maker)
                                      :
                                      //----------------------------------------------------------------
                                      features.contains('Safe') ||
                                              features.contains('شاي')
                                          ? featureContainer(
                                              icon: Icons.gif_box)
                                          :
                                          //----------------------------------------------------------------
                                          features.contains('Cloth') ||
                                                  features.contains('من')
                                              ? featureContainer(
                                                  icon: Icons.checkroom)
                                              :
                                              // ----------------------------------------------------------------
                                              features.contains('Towel') ||
                                                      features.contains('مناشف')
                                                  ? featureContainer(
                                                      icon: Icons.bathroom)
                                                  :
                                                  //----------------------------------------------------------------
                                                  features.contains('Minibar') ||
                                                          features
                                                              .contains('ميني')
                                                      ? featureContainer(
                                                          icon: Icons.kitchen)
