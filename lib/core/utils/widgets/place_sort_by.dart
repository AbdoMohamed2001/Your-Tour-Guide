        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: servicesCubit?.isServicesNameSelected == true
                    ? Colors.orange
                    : Colors.grey,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: servicesCubit?.isServicesRateSelected == true
                    ? Colors.orange
                    : Colors.grey,
                borderRadius: BorderRadius.all(
                  Radius.circular(10),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: servicesCubit?.isServiceCitySelected == true
                    ? Colors.orange
                    : Colors.grey,
                borderRadius: BorderRadius.all(
                  Radius.circular(10),
          ...
          IconButton(
            ...
            icon: servicesCubit?.isDescending == false
                ? Icon(
