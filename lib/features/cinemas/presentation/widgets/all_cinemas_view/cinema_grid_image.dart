...
class CinemaGridImage extends StatelessWidget {
  const CinemaGridImage({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
      ...
      child: Stack(
        children: [
          CachedNetworkImage(
            imageUrl: cinemaEntity.imageUrl,
            fit: BoxFit.cover,
          ...
          Positioned(
            ...
            child: BorderedText(
              ...
              child: Text(
                isArabic() ? cinemaEntity.nameArabic : cinemaEntity.name,
          ...
          Positioned(
            ...
            child: BorderedText(
              ...
              child: Text(
                isArabic()
                    ? cinemaEntity.cityNameArabic
                    : cinemaEntity.cityName,
                style: TextStyles.bold14,
              ),
            ),
          ),
