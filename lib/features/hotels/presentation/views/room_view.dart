...
import '../../domain/entities/hotel_room_entity.dart';
            ...
            children: [
              ...
              Stack(
                children: [
                  ...
                  Positioned(
                    //38
                    bottom: room.name.length > 35 || room.name.length > 35
                        ? 10
                        : 10,
                    ...
                    child: BorderedText(
                      ...
                      child: Text(
                        isArabic() ? room.name : room.name,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: Colors.white,
                          fontSize:
                              room.name.length > 35 || room.name.length > 35
                                  ? 16
                                  : 22,
                        ),
                      ),
