...
class PlacesGetLoading extends PlaceState {}

class PlacesGetSuccess extends PlaceState {
  final List<PlaceEntity> places;

  PlacesGetSuccess({required this.places});
}

class PlacesGetFailure extends PlaceState {
  final String message;

  PlacesGetFailure({required this.message});
}
