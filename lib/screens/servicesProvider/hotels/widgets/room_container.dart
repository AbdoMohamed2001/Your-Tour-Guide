            ...
            children: [
                      ...
                      children: [
                        ...
                        isArabic()
                            ...
                            : Text(
                                ...
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: hotelModel.rooms[index]['name']
                                                .toString()
                                                .length >
                                            50
                                        ? 14.5
                        ...
                        Row(
                          children: [
                            Text(
                              ...
                              style: TextStyle(fontSize: isArabic() ? 14 : 16),
                            ),
                            SizedBox(
                              width: 5,
                            ),
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              S.of(context).bed,
                              style: TextStyle(fontSize: isArabic() ? 14 : 15),
                            ),
                            isArabic()
              ...
              isArabic()
                  ? Row(
                      ...
                      children: [
                        Text(
                          "${hotelModel.roomsArabic[index]['averagePrice']} لليلة الواحدة ",
                          style: TextStyle(
                              color: Colors.orange,
                              fontWeight: FontWeight.bold),
                        ),
                  ...
                  : Row(
                      ...
                      children: [
                        Text(
                          "${hotelModel.rooms[index]['averagePrice']} for 1 night",
                          style: TextStyle(
                              color: Colors.orange,
                              fontWeight: FontWeight.bold,
