...
import 'package:your_tour_guide/screens/bottomNavScreens/favourite/favourite_screen.dart';
      ...
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) =>
                FavouriteScreen(
                  collectionName: listOfItemModel[index].collectionName.toLowerCase(),
